...
// 上传活动中拍摄的照片
const buildOutdoorPhoto = (outdoorid, id) => { 
  return "Outdoors/" + outdoorid + "/Photos/" + id + ".jpg"
}
...
// 构建个人照片存储的路径
const buildPersonPhotoSrc = (personid) => { 
  // 没有办法，只能先用时间（毫秒）作为随时文件名，等待微信解决bug
...
module.exports = {
  ...
  buildOutdoorPhoto: buildOutdoorPhoto, // 活动摄影照片的存储位置
